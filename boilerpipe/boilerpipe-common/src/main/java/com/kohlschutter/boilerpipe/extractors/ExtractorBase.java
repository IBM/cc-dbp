...
public abstract class ExtractorBase implements BoilerpipeExtractor {
   ...
   * @throws BoilerpipeProcessingException
   */
  public TextDocument getTextDocument(final String html) throws BoilerpipeProcessingException {
    try {
      return getTextDocument(new BoilerpipeSAXInput(new InputSource(new StringReader(html)))
          .getTextDocument());
    } catch (SAXException e) {
      throw new BoilerpipeProcessingException(e);
    }
   ...
   * @throws BoilerpipeProcessingException
   */
  public TextDocument getTextDocument(TextDocument doc) throws BoilerpipeProcessingException {
    process(doc);
    return doc;
  }
}
